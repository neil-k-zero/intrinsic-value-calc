#!/usr/bin/env python3
"""
Company Value Calculator - Modular Command Line Interface

This script provides a command-line interface for calculating intrinsic values
of companies using the new modular valuation system.
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  python calculate_modular.py CAT          # Calculate Caterpillar valuation
  python calculate_modular.py --list       # List available companies
  python calculate_modular.py AAPL --save  # Calculate and save Apple valuation
        '''
    )
    ...
    try:
        ...
        if companies:
            ...
            print(f"\nUsage: python calculate_modular.py <TICKER>")
            print(f"Example: python calculate_modular.py CAT")
        else:
